...
def generate_items():
    ...
    for item_id, item in item_df.iterrows():
        ...
        img_link = f"https://raw.githubusercontent.com/rh-ai-kickstart/product-recommender-system/main/recommendation-core/src/recommendation_core/generation/data/generated_images/item_{safe_name}.png"
        product_link = (
